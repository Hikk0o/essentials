...
Priorities are in `IslandPriority` (lower wins). Current order: Call, Time, Battery, Notification, Flashlight, Timer, Media, Conscious Gate, Calendar, Sound mode, Network.
